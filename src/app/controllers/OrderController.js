...
import Order from '../controllers/schemas/Order';
...
class OrderController {
  async store(request, response) {
    ...
    // Obtendo dados do request para criar o pedido (order)
    const order = {  // Adicionei o sinal de atribuição aqui
      user: {
        id: request.userId,
    ...
    // Retornando o objeto order criado com sucesso
